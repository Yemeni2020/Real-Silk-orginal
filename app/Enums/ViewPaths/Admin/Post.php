...
enum Post
{
    const ADD = [
        URI => 'add',
        VIEW => 'admin-views.post.product.add-new'
    ];

    const LIST = [
        URI => 'list',
        VIEW => 'admin-views.post.product.list'
    ];

    const UPDATE = [
        URI => 'update',
        VIEW => 'admin-views.post.product.edit',
    ];
    ...
    const SKU_COMBINATION = [
        URI => 'sku-combination',
        VIEW => 'admin-views.post.product.partials._sku_combinations'
    ];

    const SKU_EDIT_COMBINATION = [
        URI => 'sku-combination',
        VIEW => 'admin-views.post.product.partials._edit_sku_combinations'
    ];

    const DIGITAL_VARIATION_COMBINATION = [
        URI => 'digital-variation-combination',
        VIEW => 'admin-views.post.product.partials._digital-variation-combination'
    ];
