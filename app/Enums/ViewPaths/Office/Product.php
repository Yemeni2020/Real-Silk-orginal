...
enum Product
{
    const ADD = [
        URI => 'add',
        VIEW => 'office-views.product.add-new'
    ];

    const LIST = [
        URI => 'list',
        VIEW => 'office-views.product.list'
    ];

    const UPDATE = [
        URI => 'update',
        VIEW => 'office-views.product.edit'
    ];

    const VIEW = [
        URI => 'view',
        VIEW => 'office-views.product.view',
        ROUTE => 'office.products.view'
    ];
    ...
    const DIGITAL_VARIATION_COMBINATION = [
        ...
        VIEW => 'office-views.product.partials._digital-variation-combination'
    ];
