...
class factoryService
{
    ...
    {
        if (auth('factory')->attempt(['email' => $email, 'password' => $password], $rememberToken)) {
            return true;
        }
        return false;
    }
     ...
     * @return array
     */
    public function getfactoryDataForUpdate(object $request, object $factory):array
    {
        $image = $request['image'] ? $this->update(dir: 'seller/', oldImage: $factory['image'], format: 'webp', image: $request->file('image')) : $factory['image'];
        return [
     ...
     */
    public function getfactoryPasswordData(object $request):array
    {
        return [
     ...
     * @return array
     */
    public function getfactoryBankInfoData(object $request):array
    {
        return [
