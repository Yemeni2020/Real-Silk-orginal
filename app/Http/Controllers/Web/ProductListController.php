...
class ProductListController extends Controller
{
    ...
    public function theme_fashion(Request $request)
    {
        ...
        $colors_collection = Product::active()
            ->where('colors', '!=', '[]')->where('added_by', '!=', 'factories')
            ->pluck('colors')
            ->unique()
            ->toArray();
    ...
    public function theme_all_purpose(Request $request)
    {
        ...
        $porduct_data = Product::active()->where('added_by', '!=', 'factories')->with(['reviews','rating']);
        ...
        // Colors Start
        $colors_in_shop_merge = [];
        $colors_collection = Product::active()->where('added_by', '!=', 'factories')
            ->where('colors', '!=', '[]')
            ->pluck('colors')
            ->unique()
            ->toArray();
