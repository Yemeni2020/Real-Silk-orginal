...
class ShopViewController extends Controller
{
    ...
    public function default_theme($request, $id){
        ...
        $product_ids = Product::active() ->where('added_by', '!=', 'factories')->when($id == 0, function ($query) {
        ...
        $products = Product::whereIn('id', $product_ids)->where('added_by', '!=', 'factories')->paginate(12);
