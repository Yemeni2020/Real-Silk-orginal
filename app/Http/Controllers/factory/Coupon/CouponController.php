...
namespace App\Http\Controllers\factory\Coupon;

use App\Contracts\Repositories\CouponRepositoryInterface;
use App\Contracts\Repositories\CustomerRepositoryInterface;
use App\Enums\ViewPaths\factory\Coupon;
use App\Http\Controllers\BaseController;
use App\Http\Requests\factory\CouponRequest;
use App\Http\Requests\factory\CouponUpdateRequest;
...
class CouponController extends BaseController
{
    ...
    public function getAddListView(object $request): View
    {
        ...
        $coupons = $this->couponRepo->getListWhere(
            ...
            filters:['added_by' => 'seller', 'factoryId'=> $factoryId],
