...
class ProductReportController extends Controller
{
    ...
    public function all_product(Request $request){
        ...
        return view('factory-views.report.all-product', compact('products', 'chart_data', 'total_sales_value',
    ...
    public function stock_product_report(Request $request)
    {
        ...
        return view('factory-views.report.product-stock', compact('products', 'categories','search', 'stock_limit', 'sort','category_id'));
    }
