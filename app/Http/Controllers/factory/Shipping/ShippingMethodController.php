...
namespace App\Http\Controllers\factory\Shipping;
...
use App\Http\Requests\factory\ShippingMethodRequest;
    ...
    public function getShippingMethodsView():View|RedirectResponse
    {
        ...
        if ($shippingMethod === 'sellerwise_shipping') {
            ...
            $shippingMethods = $this->shippingMethodRepo->getListWhere(
                orderBy: ['id' => 'desc'],
                filters: ['creator_id' => $factoryId, 'creator_type' => 'seller'],
