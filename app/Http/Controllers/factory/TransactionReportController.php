...
class TransactionReportController extends Controller
{
    public function order_transaction_list(Request $request)
    {
        ...
        return view('factory-views.transaction.order-list', compact('customers','transactions','product_data','search',
    ...
    public function order_transaction_summary_pdf(Request $request){
        ...
        $mpdf_view = View::make('factory-views.transaction.order_transaction_summary_report_pdf', compact('data', 'company_phone', 'company_name', 'company_email', 'company_web_logo', 'status', 'duration', 'seller_info', 'customer_info'));
    ...
    public function pdf_order_wise_transaction(Request $request)
    {
        ...
        $mpdf_view = View::make('factory-views.transaction.order_wise_pdf', compact('company_phone', 'company_name', 'company_email', 'company_web_logo', 'transaction'));
    ...
    public function expense_transaction_list(Request $request)
    {
        ...
        return view('factory-views.transaction.expense-list', compact('expense_transactions_table', 'expense_transaction_chart',
    ...
    public function pdf_order_wise_expense_transaction(Request $request)
    {
        ...
        $mpdf_view = View::make('factory-views.transaction.order_wise_expense_pdf', compact('company_phone', 'company_name', 'company_email', 'company_web_logo', 'transaction'));
    ...
    public function expense_transaction_summary_pdf(Request $request)
    {
        ...
        $mpdf_view = View::make('factory-views.transaction.expense_transaction_summary_report_pdf', compact('data'));
        Helpers::gen_mpdf($mpdf_view, 'order_transaction_summary_report_', $date_type);
