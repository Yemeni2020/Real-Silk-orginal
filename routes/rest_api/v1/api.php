...
use App\Http\Controllers\RestAPI\v1\MethodPaymentController;
use App\Http\Controllers\RestAPI\v1\TapPaymentSettingsController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
    ...
    Route::group(['middleware' => 'apiGuestCheck'], function () {
        ...
        Route::group(['prefix' => 'customer'], function () {
            ...
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::get('placeMyFatorah', 'OrderController@place_order_MyFatorah');
