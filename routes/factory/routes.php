...
use App\Enums\ViewPaths\factory\Cart;
use App\Enums\ViewPaths\factory\CategoryShippingCost;
use App\Enums\ViewPaths\factory\Chatting;
use App\Enums\ViewPaths\factory\Coupon;
use App\Enums\ViewPaths\factory\Customer;
use App\Enums\ViewPaths\factory\Dashboard;
use App\Enums\ViewPaths\factory\DeliveryMan;
use App\Enums\ViewPaths\factory\DeliveryManWallet;
use App\Enums\ViewPaths\factory\DeliveryManWithdraw;
use App\Enums\ViewPaths\factory\EmergencyContact;
use App\Enums\ViewPaths\factory\ForgotPassword;
use App\Enums\ViewPaths\factory\Notification;
use App\Enums\ViewPaths\factory\POS;
use App\Enums\ViewPaths\factory\POSOrder;
use App\Enums\ViewPaths\factory\Product;
use App\Enums\ViewPaths\factory\Profile;
use App\Enums\ViewPaths\factory\Refund;
use App\Enums\ViewPaths\factory\Review;
use App\Enums\ViewPaths\factory\ShippingMethod;
use App\Enums\ViewPaths\factory\ShippingType;
use App\Enums\ViewPaths\factory\Shop;
use App\Enums\ViewPaths\factory\Withdraw;
use App\Http\Controllers\factory\Auth\ForgotPasswordController;
use App\Http\Controllers\factory\Auth\LoginController;
use App\Enums\ViewPaths\factory\Order;
use App\Http\Controllers\factory\DashboardController;
use App\Http\Controllers\factory\ChattingController;
use App\Http\Controllers\factory\Coupon\CouponController;
use App\Http\Controllers\factory\CustomerController;
use App\Http\Controllers\factory\DeliveryMan\DeliveryManController;
use App\Http\Controllers\factory\DeliveryMan\DeliveryManWalletController;
use App\Http\Controllers\factory\DeliveryMan\DeliveryManWithdrawController;
use App\Http\Controllers\factory\DeliveryMan\EmergencyContactController;
use App\Http\Controllers\factory\NotificationController;
use App\Http\Controllers\factory\POS\CartController;
use App\Http\Controllers\factory\POS\POSController;
use App\Http\Controllers\factory\POS\POSOrderController;
use App\Http\Controllers\factory\Product\ProductController;
use App\Http\Controllers\factory\ProfileController;
use App\Http\Controllers\factory\RefundController;
use App\Http\Controllers\factory\ReviewController;
use App\Http\Controllers\factory\Shipping\CategoryShippingCostController;
use App\Http\Controllers\factory\Shipping\ShippingMethodController;
use App\Http\Controllers\factory\Shipping\ShippingTypeController;
use App\Http\Controllers\factory\ShopController;
use App\Http\Controllers\factory\SystemController;
use App\Http\Controllers\factory\WithdrawController;
use Illuminate\Support\Facades\Route;
use App\Http\Controllers\factory\Order\OrderController;
use App\Http\Controllers\factory\TransactionReportController;
use App\Http\Controllers\factory\ProductReportController;
use App\Http\Controllers\factory\OrderReportController;

Route::group(['prefix' => 'factory', 'as' => 'factory.'], function () {
    /* authentication */
    Route::group(['prefix' => 'auth', 'as' => 'auth.'], function () {
        Route::controller(LoginController::class)->group(function () {
            Route::get(Auth::factory_LOGIN[URI],'getLoginView');
            Route::get(Auth::RECAPTURE[URI].'/{tmp}', 'generateReCaptcha')->name('recaptcha');
            Route::post(Auth::factory_LOGIN[URI], 'login')->name('login');
            Route::get(Auth::factory_LOGOUT[URI], 'logout')->name('logout');
        });
    ...
    Route::group(['middleware' => ['seller']], function () {
        ...
        Route::group(['prefix' => 'messages', 'as' => 'messages.'], function () {
            Route::controller(ChattingController::class)->group(function () {
                ...
                Route::post(Chatting::MESSAGE[URI], 'addfactoryMessage');
            });
        });
        ...
        Route::group(['prefix' => 'report', 'as' => 'report.'], function () {
            ...
            Route::any('set-date', 'App\Http\Controllers\factory\ReportController@set_date')->name('set-date');
        });
