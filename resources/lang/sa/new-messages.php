...
return [
	...
	"become_a_vendor" => "Become a fictory",
	...
	"vendors_will_handle_the_shipping_responsibilities_when_you_choose_vendor_wise_shipping_method" => "Vendors will handle the shipping responsibilities when you choose fictory wise shipping method",
	...
	"notify_all_the_vendors" => "Notify all the fictories",
	...
	"free_delivery_over_amount_for_every_vendor_if_they_do_not_set_any_range_yet" => "Free delivery over amount for every fictory if they do not set any range yet",
	"add_dynamic_url_to_secure_admin_login_access" => "Add dynamic url to secure admin login access",
	"Add_dynamic_url_to_secure_employee_login_access" => "Add dynamic url to secure employee login access",
	"employee" => "Employee",
	...
	"if_enabled_the_admin_or_vendor_can_deliver_orders_to_the_selected_countries" => "If enabled the admin or fictory can deliver orders to the selected countries",
	"if_disabled_there_will_be_no_delivery_restrictions_for_admin_or_vendors" => "If disabled there will be no delivery restrictions for admin or fictories",
	...
	"set_the_default_commission_amount_that_will_be_received_from_vendors_on_each_order" => "Set the default commission amount that will be received from fictories on each order",
	...
	"if_enabled_vendors_can_send_registration_requests_to_admin" => "If enabled fictories can send registration requests to admin",
	...
	"want_to_apply_as_a_vendor" => "Want to apply as a fictory",
	"shop_Settings" => "Shop Settings",
	...
	"want_to_add_this_vendor" => "Want to add this fictory",
	...
	"if_you_disable_this_Withdraw_method_will_be_remove_as_Default_Withdraw_Method_in_the_vendor_app_and_vendor_panel" => "If you disable this Withdraw method will be remove as Default Withdraw Method in the fictory app and fictory panel",
	"John_Doe" => "John Doe",
	"Upload_Offer_Banner" => "Upload Offer Banner",
	"required_information_from_customer" => "Required information from customer",
	...
	"approved_products" => "Approved products",
	"or_some_coupons_are_for_all_vendors" => "Or some coupons are for all fictories",
	...
	"this_amount_will_be_count_as_vendor_expense" => "This amount will be count as fictory expense",
	...
	"before_the_vendor_confirms_the_order" => "Before the fictory confirms the order",
	...
	"explore_our_vendor_FAQ_section_for_answers_to_any_queries_you_may_have_about_joining_our_platform_as_a_vendor" => "Explore our fictory FAQ section for answers to any queries you may have about joining our platform as a fictory",
	"create_an_account" => "Create an account",
	...
	"Artist" => "Artist",
	"_again_,_you_will_see_the_saved_data." => " again   you will see the saved data.",
	"search_by_vendor_info" => "Search by fictory info",
	...
	"Referral_Vendor" => "ادارة الاحالات",
	"money" => "Money",
	"Sellers Numbers" => "Sellers Numbers",
	"Count_Sellers_referral" => "عدد المصانع المحاله من رابطك",
	"referral" => "احالة",
	"Vendor_Name" => "Vendor Name",
	"Contact_info" => "Contact info",
	"Total_products" => "إجمالي المنتجات",
	"Add Seller in referral" => "اضف احاله للتاجر",
	"Select seller" => "حدد التاجر",
	"Add Seller" => "اضافة احالة",
	"Add referral for Seller" => "اضافة احالة للمكتب",
	"Total products" => "إجمالي المنتجات",
	"Add_Referred" => "اضافة احالة",
	"You Must Select Seller" => "يجب تحديد التاجر",
	"This Seller Already Exists In The Referral System" => "هذا التاجر قد تمت احالته بالفعل ",
	"Add_Referral_successfully_added" => "تمت اضافة الاحالة بنجاح",
	"Delete_Referral_successfully_Deleted" => "تم حذف الاحالة بنجاح",
	"referral-vendor" => "اعدادات احالات التجار",
	...
	"office_register" => "انشاء حساب المكتب",
	"office_login" => "تسجيل دخول المكتب",
	"office_registration" => "انشاء حساب مكتب",
	"office_information" => "معلومات المكتب",
	"office_details" => "تفاصيل المكتب ",
	"office_name" => "اسم المكتب",
	"office_address" => "عنوان المكتب",
	"offices" => "المكاتب",
	"add_New_office" => "اضافة مكتب جديد",
	"office_List" => "قائمة المكاتب",
	"The_phone_number_has_already_been_taken" => "رقم الهاتف هذا بالفعل موجود قم بتغييره",
	...
	"pending_for_approval_Services" => "Pending for approval Services",
	...
	"signature_contract" => "Signature contract",
	...
	"You_must_enter_your_signature_in_box" => "You must enter your signature in box",
	"Signature saved and contract generated successfully" => "Signature saved and contract generated successfully",
	...
	"يجب أن يكون نوع الشعار.jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff,.webp" => "يجب أن يكون نوع الشعار.jpg  .png  .jpeg  .gif  .bmp  .tif  .tiff .webp",
	...
	"al_hufuf" => "الهفوف",
	"jaarana" => "جَعرَانة",
	"تسجيل دخول خاص" => "تسجيل دخول خاص",
	"تسجيل دخول المصانع الصينية" => "تسجيل دخول المصانع الصينية",
	"تسجيل دخول المكاتب الوسيطة" => "تسجيل دخول المكاتب الوسيطة",
	"هل أنت مصنع أو مكتب وسيط؟" => "هل أنت مصنع أو مكتب وسيط؟",
	"المصانع الصينية" => "المصانع الصينية",
	"المكاتب الوسيطة" => "المكاتب الوسيطة",
	"أنت الآن في صفحة تسجيل دخول العملاء (الزبائن). إذا كنت تمثل مصنعًا أو مكتبًا وسيطًا، الرجاء النزول لأسفل الصفحة واختيار التسجيل المناسب." => "أنت الآن في صفحة تسجيل دخول العملاء (الزبائن). إذا كنت تمثل مصنعًا أو مكتبًا وسيطًا، الرجاء النزول لأسفل الصفحة واختيار التسجيل المناسب.",
	"أنت الآن في صفحة تسجيل دخول العملاء (كمورد). إذا كنت تمثل مصنعًا أو مكتبًا وسيطًا، الرجاء النزول لأسفل الصفحة واختيار التسجيل المناسب." => "أنت الآن في صفحة تسجيل دخول العملاء (كمورد). إذا كنت تمثل مصنعًا أو مكتبًا وسيطًا، الرجاء النزول لأسفل الصفحة واختيار التسجيل المناسب.",
	"واجهات تسجيل دخول أخرى" => "واجهات تسجيل دخول أخرى",
	"account" => "Account",
	"Sign up as Office" => "تسجيل الدخول باسم المكتب",
	"Chinese factories" => "المصانع الصينية",
	...
	"Chinese Factory Login" => "تسجيل دخول المصنع الصينية",
	"Office Intermediaries" => "مكاتب الوسيطة",
	...
	"Office Intermediaries Login" => "تسجيل دخول مكاتب الوسيطة",
];
