...
return [
	...
	"al_ahsa" => "哈萨",
	"alqunfudhah" => "昆富扎",
	"wadi_addawasir" => "瓦迪·艾德达瓦西尔",
	"albaha" => "巴哈",
	"sakaka" => "萨卡卡",
	"bishah" => "比沙",
	"domat_aljandal" => "杜马特·阿尔贾达尔",
	"alqurayyat" => "古赖叶特",
	"shaqra" => "沙克拉",
	"khafji" => "哈夫吉",
	"afif" => "阿菲夫",
	...
	"أنت الآن في صفحة تسجيل دخول العملاء (الزبائن). إذا كنت تمثل مصنعًا أو مكتبًا وسيطًا، الرجاء النزول لأسفل الصفحة واختيار التسجيل المناسب." => "纳入您的电子邮件地址以登录。 如果您代表工厂或中介办公室，请向下滚动页面",
	"Sign in as Office Intermediaries" => "以办公室中介身份登录",
	"Sign in as Chinese factories" => "以中国工厂身份登录",
	"إذا كنت تمثل مكتبًا وسيطًا (مكتب خدمات أو وساطة تجارية)، يمكنك الدخول من هنا لإدارة حسابك." => "如果您代表办公室中介（服务或贸易中介办公室），您可以在此登录以管理您的帐户。",
	"إذا كنت تمثل مصنعًا صينيًا وتريد الوصول إلى لوحة التحكم الخاصة بك، الرجاء تسجيل الدخول من هنا." => "如果您代表中国工厂并希望访问您的仪表板，请在此登录。",
	"أنت الآن في صفحة تسجيل دخول العملاء (كمورد). إذا كنت تمثل مصنعًا أو مكتبًا وسيطًا، الرجاء النزول لأسفل الصفحة واختيار التسجيل المناسب." => "您现在在客户登录页面（作为供应商）。如果您代表工厂或中介办公室，请向下滚动页面并选择适当的登录。",
	"Chinese factories" => "中国工厂",
	"Chinese Factory Login" => "中国工厂登录",
	"Office Intermediaries" => "办公室中介",
	"Office Intermediaries Login" => "办公室中介登录",
	"There_is_no_brands" => "There is no brands",
	"there_is_no_FAQs" => "There is no FAQs",
	"Sign up as Office" => "Sign up as Office",
	"1000" => "1000",
	"latest' " => "Latest  ",
	"><h1>Predator v0.0.9</h1>featured" => "  h1 Predator v0.0.9 /h1 featured",
	"><h1>Predator v0.0.9</h1>latest" => "  h1 Predator v0.0.9 /h1 latest",
	"><h1>Predator v0.0.9</h1>best-selling" => "  h1 Predator v0.0.9 /h1 best-selling",
	"><h1>Predator v0.0.9</h1>top-rated" => "  h1 Predator v0.0.9 /h1 top-rated",
	"Sorry_no_data_found_related_to_your_search" => "Sorry no data found related to your search",
