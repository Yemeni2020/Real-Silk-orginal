<?php return array (
  ...
  'After uploading products you need to edit them and set products images and choices' => '上传产品后，您需要对其进行编辑并设置产品图片和选择',
  ...
  'Default' => 'Default',
  'All input field is required' => '所有输入字段均为必填项',
  'Left' => 'Left',
  'Right' => 'Right',
  'Admin Shop Banner' => '管理商店横幅',
  '6:1' => '6:1',
  ...
  'All input field required' => '所有输入字段均需填写',
  ...
  'Account has been deleted you can not change the status!' => '帐号已被删除，无法更改状态！',
  'Chat' => 'Chat',
  ...
  'Click_here' => 'Click here',
  'Add_a _abel_(Ex:_abc_company)' => '添加 a abel （例如： abc company）',
  'Select_reCAPTCHA_v2_as_ReCAPTCHA_Type' => 'Select reCAPTCHA v2 as ReCAPTCHA Type',
  'select_sub_type' => 'Select sub type',
  'Add_Domain_(For_ex:_demo.6amtech.com)' => '添加 域名 (For ex: demo.6amtech.com)',
  ...
  '50% Off On Black Friday For All Stores Valid Until 31 January 2023' => '所有商店黑色星期五 50% 折扣有效期至 2023 年 1 月 31 日',
  'Offers' => 'Offers',
  ...
  '100%_Secure_Payment' => '100% 安全 支付',
  'We_Ensure_Secure_Transactions' => 'We Ensure Secure Transactions',
  '24/7_Support_Center' => '24/7 支持 中心',
  'Privacy Policy' => 'Privacy Policy',
  'Refund Policy' => 'Refund Policy',
  'Return Policy' => 'Return Policy',
  'Cancellation Policy' => 'Cancellation Policy',
  ...
  '100%_Authentic_Products' => '100% 正品 产品',
  ...
  '8+_characters_required' => '8+ 字符 必需',
  'please_check_the_recaptcha' => 'Please check the recaptcha',
  'coupon_bearer_is_required' => 'Coupon bearer is required',
  'select_seller_is_required' => 'Select seller is required',
  'select_customer_is_required' => 'Select customer is required',
  ...
  'this_shop_is_temporary_closed_or_on_vacation' => 'This shop is temporary closed or on vacation',
  'you_cannot_add_product_to_cart_from_this_shop_for_now' => 'You cannot add product to cart from this shop for now',
  '15 IN 1 MAKEUP COMBO SET WITH FULL MAKEUP COVERAGE set' => '15 合 1 化妆组合套装，全面覆盖彩妆套装',
  ...
  '7_Days_Return_Policy' => '7 天退货政策 7 天退货政策',
  ...
  '* multiple_zip_codes_can_be_inputted_by_comma_separating_or_pressing_enter_button' => '* 可以用逗号分隔或按回车键输入多个邮政编码',
  ...
  'Add_dynamic_url_to_secure_admin_login_access.' => '添加动态 URL 来保护管理员登录访问。',
  ...
  'total_In-House_Products' => 'Total In-House Products',
  'admin_Net_Income' => 'Admin Net Income',
  '32 inches Android Smart TV (4GB RAM and 8GB ROM)' => '32 英寸 Android 智能电视（4GB RAM 和 8GB ROM）',
  ...
  'Admin_also_reward_their_top_customers_with_wallet_money' => '管理员还会用钱包奖励他们的顶级客户',
  ...
  'All copy right reserved' => '保留所有版权',
  ...
  'Add_Fund_Transaction_Status' => '添加 资金 交易 状态',
  ...
  'welcome_back_to_factory_login' => 'Welcome back to factory login',
  'factory_login' => 'Factory login',
  'factories' => 'Factories',
  ...
  'طريقة الدفع هذه لاتدعم هذه العملة ' => 'طريقة الدفع هذه لاتدعم هذه العملة ',
