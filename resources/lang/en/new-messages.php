...
return [
	...
	"cash" => "Cash",
	"card" => "Card",
	"discounted_products" => "The Offers",
	...
	"Shop_Information" => "factory details",
	...
	"Want_to_unfollow_this_shop" => "Want to unfollow this Factory",
	...
	"Upload_Icon" => "Upload Icon",
	"all_Stores" => "All factories",
	"Find your desired stores and shop your favourite products" => "Find your desired factories and shop your favourite products",
	...
	"Send_Message_to_vendor" => "Send Message to Factory",
	"All_vendor_Page" => "All Factory Page",
	"Find_your_desired_stores_and_shop_your_favourite_products" => "Find your desired factories and shop your favourite products",
	"vendor" => "Factory",
	"chatting" => "Chatting",
	...
	"open_your_shop_and_start_selling" => "Open your shop and start selling",
	"vendor_information" => "Factory information",
	"want_to_delete_this_address " => "Want to delete this address ",
	"trash" => "Trash",
	"my_order_details_vendor_info" => "My order details Factory info",
	"top_rated_vendor" => "Top rated Factory",
	...
	"suspend_this_vendor" => "Suspend this Factory",
	"Vendor_has_been_suspended_successfully" => "Vendor has been suspended successfully",
	"want_to_approve_this_vendor" => "Want to approve this Factory",
	"want_to_active_this_vendor" => "Want to active this Factory",
	"Vendor_has_been_approved_successfully" => "Vendor has been approved successfully",
	"want_to_suspend_this_vendor" => "Want to suspend this Factory",
	...
	"want_to_update_vendor_info" => "Want to update Factory info",
	"want_to_update_vendor_password" => "Want to update Factory password",
	...
	"withdraw_information_View" => "Withdraw information View",
	"vendor_withdraw_information" => "Factory withdraw information",
	...
	"please_do_not_forget_to_notify_your_vendors_about_these_changes" => "Please do not forget to notify your factories about these changes",
	...
	"free_delivery_over_amount_for_every_vendor_if_they_do_not_set_any_range_yet" => "Free delivery over amount for every factories if they do not set any range yet",
	"add_dynamic_url_to_secure_admin_login_access" => "Add dynamic url to secure admin login access",
	"Add_dynamic_url_to_secure_employee_login_access" => "Add dynamic url to secure employee login access",
	"employee" => "Employee",
	...
	"if_enabled_the_admin_or_vendor_can_deliver_orders_to_the_selected_countries" => "If enabled the admin or factories can deliver orders to the selected countries",
	...
	"the_minimum_vendor_app_version_required_for_the_app_functionality" => "The minimum Factory app version required for the app functionality",
	"download_URL_For_Vendor_App" => "Download URL For Vendor App",
	"vendors_will_download_the_latest_vendor_app_version_using_this_URL" => "Vendors will download the latest Factory app version using this URL",
	"minimum_deliveryman_app_version" => "Minimum deliveryman app version",
	"what_is_app_version" => "What is app version",
	...
	"admin_have_no_permission_for_vendors_digital_product_upload" => "Admin have no permission for factories digital product upload",
	"Update_Addresses" => "Update Addresses",
	...
	"if_enabled_vendors_can_sell_digital_products" => "If enabled factories can sell digital products",
	"if_enabled_vendors_can_sell_digital_products_in_their_shops" => "If enabled factories can sell digital products in their shops",
	"if_disabled_vendors_can_not_sell_digital_products_in_their_shops" => "If disabled factories can not sell digital products in their shops",
	...
	"want_to_reject_this_vendor" => "Want to reject this Factory",
	...
	"search_by_shop_name_or_vendor_name_or_phone_or_email" => "Search by shop name or Factory name or phone or email",
	...
	"the_name_of_the_vendor" => "The name of the Factory",
	...
	"for_Ready_Produc”_deliveries,_customers_can_pay_&_instantly_download_pre-uploaded_digital_products._For_Ready_After_Sale_deliveries,_customers_pay_first_then_vendor_uploads_the_digital_products_that_become_available_to_customers_for_download" => "For Ready Produc  deliveries  customers can pay & instantly download pre-uploaded digital products. For Ready After Sale deliveries  customers pay first then Factory uploads the digital products that become available to customers for download",
	"For_Ready_After_Sale_deliveries,_customers_pay_first_then_vendor_uploads_the_digital_products_that_become_available_to_customers_for_download" => "For Ready After Sale deliveries  customers pay first then Factory uploads the digital products that become available to customers for download",
	"Add_Page" => "Add Page",
	"if_a_user_still_don’t_have_it,_they’ll_be_requested_a_force_app_update_when_they_opens_the_app" => "If a user still don’t have it  they’ll be requested a force app update when they opens the app",
	"if_a_user_still_don’t _have_it,_they’ll_be_requested_a_force_app_update_when_they_opens_the_app" => "If a user still don’t  have it  they’ll be requested a force app update when they opens the app",
	...
	"got_questions_about_becoming_a_vendor" => "Got questions about becoming a Factory",
	"explore_our_vendor_FAQ_section_for_answers_to_any_queries_you_may_have_about_joining_our_platform_as_a_vendor" => "Explore our vendor FAQ section for answers to any queries you may have about joining our platform as a Factory",
	"create_an_account" => "Create an account",
	...
	"if_you`re_not_sure_where_to_find_these_details,_check_the_email_provider`s_documentation_or_support_resources_for_guidance" => "If you`re not sure where to find these details  check the email provider`s documentation or support resources for guidance",
	"Review_ID" => "Review ID",
	"Admin_can_not_reply_to_vendor_product_review" => "Admin can not reply to Factory product review",
	...
	"ReCAPTCHA Failed!" => "ReCAPTCHA Failed!",
	"Vendor_Registration_Successfully_Completed" => "Factory/office Registration Successfully Completed",
	...
	"download_free_vendor_app" => "Download free Factory app",
	...
	"vendor_app" => "Factory app",
	"deliveryman_app" => "Deliveryman app",
	"vendor_panel" => "Factory panel",
	...
	"publishing_houses" => "Digital Products",
	"Product_Type" => "Product Type",
	"Sort_By" => "Sort By",
	"Sidebar" => "Sidebar",
	...
	"months)" => "Months)",
	"Month" => "Month",
	"top_vendor" => "Top Factory",
	"top_vendor_list_refers_to_displaying_a_list_based_on_most_ordered_items_of_that_vendor_and_highly_rated" => "Top Factory list refers to displaying a list based on most ordered items of that Factory and highly rated",
	...
	"vendor_product_list" => "Vendor product list",
	"the_vendor_product_list_is_for_displaying_the_products_which_are_mostly_ordered" => "The Factory product list is for displaying the products which are mostly ordered",
	...
	"no_vendor_found" => "No Factory found",
	...
	"Vendor_Registration_Approved" => "Factory/office Registration Approved",
	...
	"set_the_value_in_percentage_for_the_default_commission_that_will_be_received_from_vendors_on_each_order" => "Set the value in percentage for the default commission that will be received from factories on each order",
	...
	"{id:5,template_name:forgot-password,user_type:customer,template_design_name:forgot-password,title:Change Password Request,body:<p><b>Hi {userName},<\/b><\/p><p>Please click the link below to change your password.<\/p>,banner_image:null,image:null,logo:null,button_name:null,button_url:null,footer_text:Please contact us for any queries, we\u2019re always happy to help.,copyright_text:Copyright 2024 Real Silk. All right reserved.,pages:null,social_media:null,hide_field:[product_information,order_information,button_content,banner_image],button_content_status:1,product_information_status:1,order_information_status:1,status:1,created_at:2024-10-22T09:43:49.000000Z,updated_at:2024-10-22T09:43:49.000000Z,logo_full_url:{key:null,path:null,status:404},image_full_url:{key:null,path:null,status:404},banner_image_full_url:{key:null,path:null,status:404},translations:[],translation_current_language:[],storage:[]}_mail_is_off" => "{id:5 template name:forgot-password user type:customer template design name:forgot-password title:Change Password Request body: p  b Hi {userName}  \/b  \/p  p Please click the link below to change your password. \/p  banner image:null image:null logo:null button name:null button url:null footer text:Please contact us for any queries  we\u2019re always happy to help. copyright text:Copyright 2024 Real Silk. All right reserved. pages:null social media:null hide field:[product information order information button content banner image] button content status:1 product information status:1 order information status:1 status:1 created at:2024-10-22T09:43:49.000000Z updated at:2024-10-22T09:43:49.000000Z logo full url:{key:null path:null status:404} image full url:{key:null path:null status:404} banner image full url:{key:null path:null status:404} translations:[] translation current language:[] storage:[]} mail is off",
	"{id:5,template_name:forgot-password,user_type:customer,template_design_name:forgot-password,title:Change Password Request,body:<p><b>Hi {userName},<\/b><\/p><p>Please click the link below to change your password.<\/p>,banner_image:null,image:null,logo:null,button_name:null,button_url:null,footer_text:Please contact us for any queries, we\u2019re always happy to help.,copyright_text:Copyright 2024 Real Silk. All right reserved.,pages:null,social_media:null,hide_field:[product_information,order_information,button_content,banner_image],button_content_status:1,product_information_status:1,order_information_status:1,status:0,created_at:2024-10-22T09:43:49.000000Z,updated_at:2024-10-22T09:45:01.000000Z,logo_full_url:{key:null,path:null,status:404},image_full_url:{key:null,path:null,status:404},banner_image_full_url:{key:null,path:null,status:404},translations:[],translation_current_language:[],storage:[]}_mail_is_off" => "{id:5 template name:forgot-password user type:customer template design name:forgot-password title:Change Password Request body: p  b Hi {userName}  \/b  \/p  p Please click the link below to change your password. \/p  banner image:null image:null logo:null button name:null button url:null footer text:Please contact us for any queries  we\u2019re always happy to help. copyright text:Copyright 2024 Real Silk. All right reserved. pages:null social media:null hide field:[product information order information button content banner image] button content status:1 product information status:1 order information status:1 status:0 created at:2024-10-22T09:43:49.000000Z updated at:2024-10-22T09:45:01.000000Z logo full url:{key:null path:null status:404} image full url:{key:null path:null status:404} banner image full url:{key:null path:null status:404} translations:[] translation current language:[] storage:[]} mail is off",
	"reset_Password" => "Reset Password",
	...
	"want_to_turn_ON_my_fatorah_as_the_Digital_Payment_method" => "Want to turn ON my fatorah as the Digital Payment method",
	...
	"tap payment settings" => "Tap payment settings",
	"if_enabled,_the_delivery_info_will_be_available_on_the_system." => "If enabled  the delivery info will be available on the system.",
	"if_enabled,_the_safe_payment_will_be_available_on_the_system." => "If enabled  the safe payment will be available on the system.",
	...
	"company_information22" => "Company information22",
	...
	"Error Faild  as Is Requerd" => "Error Faild as Is Requerd",
	"Order submitted successfully. Redirecting to WhatsApp..." => "Order submitted successfully. Redirecting to WhatsApp...",
	"details order servic..." => "Details order servic...",
	"form items" => "Form items",
	"option product detai..." => "Option product detai...",
	...
	"Order_not_found" => "Order not found",
	"service" => "Service",
	"Login For Submit In This Service" => "Login For Submit In This Service",
	"Customer Email" => "Customer Email",
	"Form_details_for " => "Form details for ",
	"Customer_details_for " => "Customer details for ",
	...
	"Referral_Vendor" => "Referral Vendor",
	"statusc" => "Statusc",
	"Count_Sellers_referral" => "Count Sellers referral",
	"referral-vendor" => "Referral-vendor",
	"Vendor_Name" => "Vendor Name",
	"Contact_info" => "Contact info",
	"Total_products" => "Total products",
	...
	"referral" => "Referral",
	"Add Seller in referral" => "Add Seller in referral",
	"Select seller" => "Select seller",
	"Add Seller" => "Add Seller",
	"Add_Referral_successfully_added" => "Add Referral successfully added",
	"You Must Select Seller" => "You Must Select Seller",
	"The Seller Is Exists" => "The Seller Is Exists",
	"This Seller Already Exists In The Referral System" => "This Seller Already Exists In The Referral System",
	"referredBy" => "ReferredBy",
	"Add commission for referral's Seller" => "Add commission for referral s Seller",
	"The percentage is from the admin’s commission percentage. For example, if you enter the value 20 and the admin takes 30 percent from the merchant, then the merchant who was given the referral will take 20 percent of the admin’s commission." => "The percentage is from the admin’s commission percentage. For example  if you enter the value 20 and the admin takes 30 percent from the merchant  then the merchant who was given the referral will take 20 percent of the admin’s commission.",
	"Add referral for Seller" => "Add referral for Seller",
	"Add_Referred" => "Add Referred",
	"Total products" => "Total products",
	"referral_commission" => "Referral commission",
	"total_Shop_Tax" => "Total Shop Tax",
	"total_admin_commission" => "Total admin commission",
	"total_referral_commission" => "Total referral commission",
	"total_referral" => "Total referral",
	"total_referral_Commission" => "Total referral Commission",
	"Sellers_referral" => "Sellers referral",
	...
	"add_new_Office" => "Add new Office",
	"want_to_add_this_office" => "Want to add this office",
	"personal_information" => "Personal information",
	"The banner field is required." => "The banner field is required.",
	"The phone has already been taken" => "The phone has already been taken",
	"office_withdraw_information" => "Office withdraw information",
	...
	"<p><strong>سياسات منصة حرير حقيقي التجارية </strong></p>

<p><strong>1. سياسة الخصوصية</strong></p>

<p><strong>مقدمة</strong><strong>:</strong> في <em>منصة حرير حقيقي التجارية</em>، نلتزم بحماية خصوصية جميع المستخدمين، سواء كانوا عملاء أو مصانع. توضح هذه السياسة كيفية جمع البيانات الشخصية، وكيفية استخدامها وحمايتها، والضوابط المعمول بها لحماية هذه البيانات وفقًا للوائح السارية.</p>

<p><strong>جمع المعلومات</strong><strong>:</strong> نقوم بجمع البيانات الشخصية من العملاء والمصانع لأغراض إدارة العمليات التجارية، بما في ذلك: الاسم، معلومات الاتصال، تفاصيل الشحن، ومعلومات المنتجات.</p>

<p><strong>استخدام البيانات</strong><strong>:</strong> تُستخدم البيانات لتسهيل عملية البيع والشحن بين المصانع والعملاء، ولتحسين خدماتنا، وضمان تجربة استخدام سلسة للمنصة.</p>

<p><strong>مشاركة البيانات</strong><strong>:</strong> نشارك البيانات فقط مع الأطراف الضرورية (مثل شركات الشحن أو الجهات الحكومية) التي تحتاج إلى هذه المعلومات لتقديم الخدمات بشكل صحيح، مع الامتثال الكامل للأنظمة المحلية والدولية.</p>

<p><strong>حماية المعلومات</strong><strong>:</strong> نتخذ التدابير التقنية والتنظيمية اللازمة لحماية المعلومات الشخصية من الاختراق أو الوصول غير المصرح به، بما في ذلك استخدام تقنيات التشفير وبرامج الحماية.</p>

<p><strong>حقوق المستخدمين</strong><strong>:</strong> يحق للعملاء والمصانع الوصول إلى بياناتهم الشخصية وتعديلها أو حذفها بناءً على طلبهم، وفقًا للوائح حماية البيانات المعمول بها في المملكة العربية السعودية.</p>

<hr />
<p><strong>2. سياسة الدفع</strong></p>

<p><strong>طرق الدفع المعتمدة</strong><strong>:</strong> تقبل <em>منصة حرير حقيقي التجارية</em> طرق الدفع الآمنة والمعتمدة مثل: بطاقات الائتمان (Visa وMasterCard)، التحويل البنكي، وطرق الدفع المحلية المعتمدة في المملكة العربية السعودية مثل &quot;مدى&quot;.</p>

<p><strong>أمان الدفع</strong><strong>:</strong> يتم حماية كافة المعاملات المالية باستخدام بروتوكولات أمان الدفع القياسية (PCI DSS) وتقنيات تشفير البيانات.</p>

<p><strong>شروط الدفع</strong><strong>:</strong> يجب على العملاء دفع المستحقات عند تقديم الطلبات. إذا كانت طريقة الدفع هي التحويل البنكي، فيجب تأكيد الدفعة قبل شحن المنتجات.</p>

<hr />
<p><strong>3. سياسة الاسترداد</strong></p>

<p><strong>إعادة الأموال</strong><strong>:</strong> يحق للعملاء طلب استرداد الأموال في حالة عدم مطابقة المنتجات للمواصفات أو وجود عيوب فيها، وذلك خلال 14 يوماً من استلام الطلب. يجب أن تكون المنتجات بحالتها الأصلية وغير مستخدمة.</p>

<p><strong>إجراءات استرداد الأموال</strong><strong>:</strong> في حال الموافقة على طلب الاسترداد، يتم إعادة الأموال إلى العميل بنفس طريقة الدفع المستخدمة.</p>

<hr />
<p><strong>4. سياسة الشحن والتوصيل</strong></p>

<p><strong>خيارات الشحن</strong><strong>:</strong> تتيح <em>منصة حرير حقيقي التجارية</em> خيارات متعددة للشحن من الصين إلى المملكة العربية السعودية، وتشمل الشحن الجوي والبحري حسب احتياجات العميل.</p>

<p><strong>الوقت المقدر للتوصيل</strong><strong>:</strong> تصل الطلبات إلى العملاء خلال فترة تتراوح بين 7 إلى 14 يوماً. في حال حدوث أي تأخير، يتم إبلاغ العميل بأسباب التأخير والمدة المتوقعة للشحن.</p>
...
<p><strong>تكاليف الشحن</strong><strong>:</strong> تُحسب تكاليف الشحن بناءً على وزن المنتجات ومكان التسليم. قد تُضاف تكاليف الشحن إلى الفاتورة النهائية أو تُحسب بشكل منفصل حسب الاتفاق المسبق.</p>

<hr />
<p><strong>5. سياسة حماية حقوق المصنع</strong></p>

<p><strong>حماية الملكية الفكرية</strong><strong>:</strong> نلتزم بحماية حقوق الملكية الفكرية الخاصة بالمصانع الشريكة، بما في ذلك حماية العلامات التجارية والمنتجات من التزييف أو الاستخدام غير القانوني.</p>

<p><strong>ضمان الجودة</strong><strong>:</strong> يجب على المصانع الالتزام بتقديم منتجات مطابقة للمواصفات والجودة المتفق عليها. في حالة وجود أي عيوب في المنتجات، يتحمل المصنع مسؤولية استبدال المنتجات أو تعويض العملاء.</p>

<hr />
<p><strong>6. سياسة الدفع للمصانع</strong></p>

<p><strong>شروط الدفع</strong><strong>:</strong> تلتزم <em>منصة حرير حقيقي التجارية</em> بدفع المستحقات للمصانع فقط بعد استلام العميل للمنتج والتحقق من جودته ومطابقته للمواصفات المتفق عليها.</p>

<p><strong>عملية الدفع</strong><strong>:</strong></p>

<ol>
	<li>بعد شحن المنتجات إلى العميل، يتم متابعة حالة الشحن من خلال المنصة.</li>
	<li>بمجرد تأكيد العميل استلام المنتج والتحقق من مطابقته للجودة والمواصفات، يتم إصدار الدفعة إلى المصنع.</li>
	<li>في حال وجود أي مشكلات في الجودة أو المواصفات، يتم تأجيل الدفع حتى يتم حل المشكلة بالكامل.</li>
</ol>

<p><strong>إجراءات التحقق من الجودة</strong><strong>:</strong> تحتفظ <em>منصة حرير حقيقي التجارية</em> بحقها في مراقبة وفحص جودة المنتجات من خلال العملاء بعد استلامها. إذا تبين أن المنتج غير مطابق للمواصفات أو أنه معيب، سيتم إبلاغ المصنع لمعالجة المشكلة قبل إتمام الدفع.</p>

<p><strong>تأخير الدفعات</strong><strong>:</strong> في حال وجود تأخير في الشحن أو اكتشاف عيوب في المنتج، سيتم تأجيل دفع المستحقات للمصنع إلى حين حل المشكلة، سواء كان ذلك عبر استبدال المنتج أو تقديم تعويض للعميل.</p>

<hr />
<p><strong>7. متطلبات دخول المنتجات إلى السعودية</strong></p>

<p><strong>شهادات المطابقة</strong><strong>:</strong> يتعين على جميع المصانع ضمان أن المنتجات المصدرة إلى المملكة العربية السعودية حاصلة على شهادات مطابقة من هيئة المواصفات والمقاييس السعودية (SASO).</p>

<p><strong>التسجيل في هيئة</strong><strong> SASO:</strong> يجب على المصانع التأكد من التسجيل في هيئة المواصفات والمقاييس السعودية، وتقديم الوثائق اللازمة لضمان الامتثال للوائح المحلية المتعلقة بالجودة والسلامة.</p>

<p><strong>الفواتير وشهادات المنشأ</strong><strong>:</strong> يجب على المصانع تقديم فواتير وشهادات منشأ صحيحة لكل شحنة، لضمان دخول المنتجات إلى السعودية بشكل قانوني.</p>

<p><strong>التعبئة والتغليف</strong><strong>:</strong> يجب تغليف المنتجات بطريقة تحميها أثناء الشحن، مع مراعاة المعايير الخاصة بالتعبئة للحفاظ على المنتجات سليمة حتى وصولها إلى العميل.</p>

<p><strong>الامتثال للوائح الجمارك والضرائب</strong><strong>:</strong> يتعين على المصانع الالتزام باللوائح الجمركية السعودية وتغطية جميع الضرائب والرسوم الجمركية المطلوبة لضمان دخول المنتجات إلى المملكة دون تأخير.</p>

<hr />
<p><strong>8. شروط الخدمة للمصانع والعملاء</strong></p>

<p><strong>استخدام المنصة</strong><strong>:</strong> يوافق جميع المستخدمين على الالتزام بسياسات وشروط استخدام المنصة كما هو موضح في هذه الوثيقة. أي استخدام غير قانوني أو يتنافى مع شروط الخدمة سيؤدي إلى تعليق الحساب أو إنهائه.</p>

<p><strong>التزامات المصانع</strong><strong>:</strong> يجب على المصانع تقديم منتجات مطابقة للمواصفات والتأكد من شحنها في الوقت المحدد، بالإضافة إلى الالتزام بجميع المعايير واللوائح المتعلقة بالتوريد والجمارك.</p>

<p><strong>حل النزاعات</strong><strong>:</strong> في حالة حدوث أي نزاع بين الأطراف، يتم اللجوء إلى وسائل التسوية القانونية أو التحكيم وفقاً للقوانين المعمول بها في المملكة العربية السعودية.</p>

<p>&nbsp;</p>" => " p  strong سياسات منصة حرير حقيقي التجارية  /strong  /p   p  strong 1. سياسة الخصوصية /strong  /p   p  strong مقدمة /strong  strong : /strong  في  em منصة حرير حقيقي التجارية /em ، نلتزم بحماية خصوصية جميع المستخدمين، سواء كانوا عملاء أو مصانع. توضح هذه السياسة كيفية جمع البيانات الشخصية، وكيفية استخدامها وحمايتها، والضوابط المعمول بها لحماية هذه البيانات وفقًا للوائح السارية. /p   p  strong جمع المعلومات /strong  strong : /strong  نقوم بجمع البيانات الشخصية من العملاء والمصانع لأغراض إدارة العمليات التجارية، بما في ذلك: الاسم، معلومات الاتصال، تفاصيل الشحن، ومعلومات المنتجات. /p   p  strong استخدام البيانات /strong  strong : /strong  تُستخدم البيانات لتسهيل عملية البيع والشحن بين المصانع والعملاء، ولتحسين خدماتنا، وضمان تجربة استخدام سلسة للمنصة. /p   p  strong مشاركة البيانات /strong  strong : /strong  نشارك البيانات فقط مع الأطراف الضرورية (مثل شركات الشحن أو الجهات الحكومية) التي تحتاج إلى هذه المعلومات لتقديم الخدمات بشكل صحيح، مع الامتثال الكامل للأنظمة المحلية والدولية. /p   p  strong حماية المعلومات /strong  strong : /strong  نتخذ التدابير التقنية والتنظيمية اللازمة لحماية المعلومات الشخصية من الاختراق أو الوصول غير المصرح به، بما في ذلك استخدام تقنيات التشفير وبرامج الحماية. /p   p  strong حقوق المستخدمين /strong  strong : /strong  يحق للعملاء والمصانع الوصول إلى بياناتهم الشخصية وتعديلها أو حذفها بناءً على طلبهم، وفقًا للوائح حماية البيانات المعمول بها في المملكة العربية السعودية. /p   hr /   p  strong 2. سياسة الدفع /strong  /p   p  strong طرق الدفع المعتمدة /strong  strong : /strong  تقبل  em منصة حرير حقيقي التجارية /em  طرق الدفع الآمنة والمعتمدة مثل: بطاقات الائتمان (Visa وMasterCard)، التحويل البنكي، وطرق الدفع المحلية المعتمدة في المملكة العربية السعودية مثل &quot مدى&quot . /p   p  strong أمان الدفع /strong  strong : /strong  يتم حماية كافة المعاملات المالية باستخدام بروتوكولات أمان الدفع القياسية (PCI DSS) وتقنيات تشفير البيانات. /p   p  strong شروط الدفع /strong  strong : /strong  يجب على العملاء دفع المستحقات عند تقديم الطلبات. إذا كانت طريقة الدفع هي التحويل البنكي، فيجب تأكيد الدفعة قبل شحن المنتجات. /p   hr /   p  strong 3. سياسة الاسترداد /strong  /p   p  strong إعادة الأموال /strong  strong : /strong  يحق للعملاء طلب استرداد الأموال في حالة عدم مطابقة المنتجات للمواصفات أو وجود عيوب فيها، وذلك خلال 14 يوماً من استلام الطلب. يجب أن تكون المنتجات بحالتها الأصلية وغير مستخدمة. /p   p  strong إجراءات استرداد الأموال /strong  strong : /strong  في حال الموافقة على طلب الاسترداد، يتم إعادة الأموال إلى العميل بنفس طريقة الدفع المستخدمة. /p   hr /   p  strong 4. سياسة الشحن والتوصيل /strong  /p   p  strong خيارات الشحن /strong  strong : /strong  تتيح  em منصة حرير حقيقي التجارية /em  خيارات متعددة للشحن من الصين إلى المملكة العربية السعودية، وتشمل الشحن الجوي والبحري حسب احتياجات العميل. /p   p  strong الوقت المقدر للتوصيل /strong  strong : /strong  تصل الطلبات إلى العملاء خلال فترة تتراوح بين 7 إلى 14 يوماً. في حال حدوث أي تأخير، يتم إبلاغ العميل بأسباب التأخير والمدة المتوقعة للشحن. /p   p &nbsp  /p   p &nbsp  /p   p &nbsp  /p   p &nbsp  /p   p  strong تكاليف الشحن /strong  strong : /strong  تُحسب تكاليف الشحن بناءً على وزن المنتجات ومكان التسليم. قد تُضاف تكاليف الشحن إلى الفاتورة النهائية أو تُحسب بشكل منفصل حسب الاتفاق المسبق. /p   hr /   p  strong 5. سياسة حماية حقوق المصنع /strong  /p   p  strong حماية الملكية الفكرية /strong  strong : /strong  نلتزم بحماية حقوق الملكية الفكرية الخاصة بالمصانع الشريكة، بما في ذلك حماية العلامات التجارية والمنتجات من التزييف أو الاستخدام غير القانوني. /p   p  strong ضمان الجودة /strong  strong : /strong  يجب على المصانع الالتزام بتقديم منتجات مطابقة للمواصفات والجودة المتفق عليها. في حالة وجود أي عيوب في المنتجات، يتحمل المصنع مسؤولية استبدال المنتجات أو تعويض العملاء. /p   hr /   p  strong 6. سياسة الدفع للمصانع /strong  /p   p  strong شروط الدفع /strong  strong : /strong  تلتزم  em منصة حرير حقيقي التجارية /em  بدفع المستحقات للمصانع فقط بعد استلام العميل للمنتج والتحقق من جودته ومطابقته للمواصفات المتفق عليها. /p   p  strong عملية الدفع /strong  strong : /strong  /p   ol   li بعد شحن المنتجات إلى العميل، يتم متابعة حالة الشحن من خلال المنصة. /li   li بمجرد تأكيد العميل استلام المنتج والتحقق من مطابقته للجودة والمواصفات، يتم إصدار الدفعة إلى المصنع. /li   li في حال وجود أي مشكلات في الجودة أو المواصفات، يتم تأجيل الدفع حتى يتم حل المشكلة بالكامل. /li   /ol   p  strong إجراءات التحقق من الجودة /strong  strong : /strong  تحتفظ  em منصة حرير حقيقي التجارية /em  بحقها في مراقبة وفحص جودة المنتجات من خلال العملاء بعد استلامها. إذا تبين أن المنتج غير مطابق للمواصفات أو أنه معيب، سيتم إبلاغ المصنع لمعالجة المشكلة قبل إتمام الدفع. /p   p  strong تأخير الدفعات /strong  strong : /strong  في حال وجود تأخير في الشحن أو اكتشاف عيوب في المنتج، سيتم تأجيل دفع المستحقات للمصنع إلى حين حل المشكلة، سواء كان ذلك عبر استبدال المنتج أو تقديم تعويض للعميل. /p   hr /   p  strong 7. متطلبات دخول المنتجات إلى السعودية /strong  /p   p  strong شهادات المطابقة /strong  strong : /strong  يتعين على جميع المصانع ضمان أن المنتجات المصدرة إلى المملكة العربية السعودية حاصلة على شهادات مطابقة من هيئة المواصفات والمقاييس السعودية (SASO). /p   p  strong التسجيل في هيئة /strong  strong  SASO: /strong  يجب على المصانع التأكد من التسجيل في هيئة المواصفات والمقاييس السعودية، وتقديم الوثائق اللازمة لضمان الامتثال للوائح المحلية المتعلقة بالجودة والسلامة. /p   p  strong الفواتير وشهادات المنشأ /strong  strong : /strong  يجب على المصانع تقديم فواتير وشهادات منشأ صحيحة لكل شحنة، لضمان دخول المنتجات إلى السعودية بشكل قانوني. /p   p  strong التعبئة والتغليف /strong  strong : /strong  يجب تغليف المنتجات بطريقة تحميها أثناء الشحن، مع مراعاة المعايير الخاصة بالتعبئة للحفاظ على المنتجات سليمة حتى وصولها إلى العميل. /p   p  strong الامتثال للوائح الجمارك والضرائب /strong  strong : /strong  يتعين على المصانع الالتزام باللوائح الجمركية السعودية وتغطية جميع الضرائب والرسوم الجمركية المطلوبة لضمان دخول المنتجات إلى المملكة دون تأخير. /p   hr /   p  strong 8. شروط الخدمة للمصانع والعملاء /strong  /p   p  strong استخدام المنصة /strong  strong : /strong  يوافق جميع المستخدمين على الالتزام بسياسات وشروط استخدام المنصة كما هو موضح في هذه الوثيقة. أي استخدام غير قانوني أو يتنافى مع شروط الخدمة سيؤدي إلى تعليق الحساب أو إنهائه. /p   p  strong التزامات المصانع /strong  strong : /strong  يجب على المصانع تقديم منتجات مطابقة للمواصفات والتأكد من شحنها في الوقت المحدد، بالإضافة إلى الالتزام بجميع المعايير واللوائح المتعلقة بالتوريد والجمارك. /p   p  strong حل النزاعات /strong  strong : /strong  في حالة حدوث أي نزاع بين الأطراف، يتم اللجوء إلى وسائل التسوية القانونية أو التحكيم وفقاً للقوانين المعمول بها في المملكة العربية السعودية. /p   p &nbsp  /p ",
	"generate_ai" => "Generate ai",
	"AI_config" => "AI config",
	"translate_ai" => "Translate ai",
	"Translate_using" => "Translate using",
	"deepl" => "Deepl",
	"OpenAI" => "OpenAI",
	"DeepSeekAI" => "DeepSeekAI",
	"OpenAI Translate" => "OpenAI Translate",
	"want_to_turn_ON_openAI_trnslate" => "Want to turn ON openAI trnslate",
	"want_to_turn_OFF_openAI_trnslate" => "Want to turn OFF openAI trnslate",
	"if_enabled,openAi_translate_is_running" => "If enabled openAi translate is running",
	"if_enabled,openAi_translate_is_disable" => "If enabled openAi translate is disable",
	"store_API_Key" => "Store API Key",
	"Setting Translate" => "Setting Translate",
	"DeepSeekAI Translate" => "DeepSeekAI Translate",
	"want_to_turn_ON_DeepSeekAI_trnslate" => "Want to turn ON DeepSeekAI trnslate",
	"want_to_turn_OFF_DeepSeekAI_trnslate" => "Want to turn OFF DeepSeekAI trnslate",
	"if_enabled,DeepSeekAI_translate_is_running" => "If enabled DeepSeekAI translate is running",
	"if_enabled,DeepSeekAI_translate_is_disable" => "If enabled DeepSeekAI translate is disable",
	"deepl Translate" => "Deepl Translate",
	"want_to_turn_ON_deepl_trnslate" => "Want to turn ON deepl trnslate",
	"want_to_turn_OFF_deepl_trnslate" => "Want to turn OFF deepl trnslate",
	"if_enabled,deepl_translate_is_running" => "If enabled deepl translate is running",
	"if_enabled,deepl_translate_is_disable" => "If enabled deepl translate is disable",
	"Ai DeepSeekAI translate updated successfully." => "Ai DeepSeekAI translate updated successfully.",
	"Ai deepl translate updated successfully." => "Ai deepl translate updated successfully.",
	"setting Translate" => "Setting Translate",
	"Default_Translate" => "Default Translate",
	"auto_translate_after_save" => "Auto translate after save",
	"want_to_turn_ON_auto_trnslate" => "Want to turn ON auto trnslate",
	"want_to_turn_OFF_auto_trnslate" => "Want to turn OFF auto trnslate",
	"if_enabled,auto_translate_is_running" => "If enabled auto translate is running",
	"if_enabled,auto_translate_is_disable" => "If enabled auto translate is disable",
	"Translate_After_save" => "Translate After save",
	"Ai setting translate updated successfully." => "Ai setting translate updated successfully.",
	"setting generate" => "Setting generate",
	"Default_generate" => "Default generate",
	...
	"product_variation_setupss" => "Product variation setupss",
	"service_Edit" => "Service Edit",
	"service_SKU" => "Service SKU",
	"service_variation_setup" => "Service variation setup",
	...
	"approved_service_list" => "Approved service list",
	...
	"Check_Your_Service" => "Check Your Service",
	"Select_Your_Service" => "Select Your Service",
	"Saved_Your_Service" => "Saved Your Service",
