...
return [
	...
	"become_a_vendor" => "Become a fictory or office",
	"vendor_login" => "fictory or office login",
	"vendor_Apply" => "fictory Apply",
	"vendor_Info" => "fictory Info",
	"vendor_info" => "fictory info",
	"chat_with_vendor" => "Chat with fictory",
	"Send_Message_to_vendor" => "Send Message to fictory",
	"All_vendor_Page" => "All fictory Page",
	...
	"contact_with_vendor" => "Contact with fictory",
	"Chat_with_vendor" => "Chat with fictory",
	"all_Brands_Page" => "All Brands Page",
	"vendor_registration" => "fictory/office registration",
	"vendor_image" => "fictory image",
	"loader" => "Loader",
	"vendor_reg" => "fictory reg",
	"vendors" => "fictories",
	"dark_Mode" => "Dark Mode",
	"light_Mode" => "Light Mode",
	"vendor_apply" => "Vendor apply",
	"open_your_shop_and_start_selling" => "Open your shop and start selling",
	"vendor_information" => "fictory/Office information",
	"want_to_delete_this_address " => "Want to delete this address ",
	"trash" => "Trash",
	"my_order_details_vendor_info" => "My order details fictory info",
	"top_rated_vendor" => "Top rated fictory",
	...
	"welcome_back_to_vendor_login" => "Welcome back to fictory or office login",
	...
	"suspend_this_vendor" => "Suspend this fictory",
	"Vendor_has_been_suspended_successfully" => "Vendor has been suspended successfully",
	"want_to_approve_this_vendor" => "Want to approve this fictory",
	"want_to_active_this_vendor" => "Want to active this fictory",
	"Vendor_has_been_approved_successfully" => "Vendor has been approved successfully",
	"want_to_suspend_this_vendor" => "Want to suspend this fictory",
	...
	"want_to_update_vendor_info" => "Want to update fictory info",
	"want_to_update_vendor_password" => "Want to update fictory password",
	...
	"withdraw_information_View" => "Withdraw information View",
	"vendor_withdraw_information" => "fictory withdraw information",
	...
	"please_do_not_forget_to_notify_your_vendors_about_these_changes" => "Please do not forget to notify your fictories about these changes",
	...
	"free_delivery_over_amount_for_every_vendor_if_they_do_not_set_any_range_yet" => "Free delivery over amount for every fictories if they do not set any range yet",
	"add_dynamic_url_to_secure_admin_login_access" => "Add dynamic url to secure admin login access",
	"Add_dynamic_url_to_secure_employee_login_access" => "Add dynamic url to secure employee login access",
	"employee" => "Employee",
	...
	"if_enabled_the_admin_or_vendor_can_deliver_orders_to_the_selected_countries" => "If enabled the admin or fictories can deliver orders to the selected countries",
	...
	"the_minimum_vendor_app_version_required_for_the_app_functionality" => "The minimum fictory app version required for the app functionality",
	"download_URL_For_Vendor_App" => "Download URL For Vendor App",
	"vendors_will_download_the_latest_vendor_app_version_using_this_URL" => "Vendors will download the latest fictory app version using this URL",
	"minimum_deliveryman_app_version" => "Minimum deliveryman app version",
	"what_is_app_version" => "What is app version",
	...
	"admin_have_no_permission_for_vendors_digital_product_upload" => "Admin have no permission for fictories digital product upload",
	"Update_Addresses" => "Update Addresses",
	...
	"if_enabled_vendors_can_sell_digital_products" => "If enabled fictories can sell digital products",
	"if_enabled_vendors_can_sell_digital_products_in_their_shops" => "If enabled fictories can sell digital products in their shops",
	"if_disabled_vendors_can_not_sell_digital_products_in_their_shops" => "If disabled fictories can not sell digital products in their shops",
	...
	"want_to_reject_this_vendor" => "Want to reject this fictory",
	...
	"search_by_shop_name_or_vendor_name_or_phone_or_email" => "Search by shop name or fictory name or phone or email",
	...
	"vendor_Registration" => "fictory Registration",
	...
	"the_name_of_the_vendor" => "The name of the fictory",
	...
	"for_Ready_Produc”_deliveries,_customers_can_pay_&_instantly_download_pre-uploaded_digital_products._For_Ready_After_Sale_deliveries,_customers_pay_first_then_vendor_uploads_the_digital_products_that_become_available_to_customers_for_download" => "For Ready Produc  deliveries  customers can pay & instantly download pre-uploaded digital products. For Ready After Sale deliveries  customers pay first then fictory uploads the digital products that become available to customers for download",
	"For_Ready_After_Sale_deliveries,_customers_pay_first_then_vendor_uploads_the_digital_products_that_become_available_to_customers_for_download" => "For Ready After Sale deliveries  customers pay first then fictory uploads the digital products that become available to customers for download",
	"Add_Page" => "Add Page",
	"if_a_user_still_don’t_have_it,_they’ll_be_requested_a_force_app_update_when_they_opens_the_app" => "If a user still don’t have it  they’ll be requested a force app update when they opens the app",
	"if_a_user_still_don’t _have_it,_they’ll_be_requested_a_force_app_update_when_they_opens_the_app" => "If a user still don’t  have it  they’ll be requested a force app update when they opens the app",
	...
	"got_questions_about_becoming_a_vendor" => "Got questions about becoming a fictory",
	"explore_our_vendor_FAQ_section_for_answers_to_any_queries_you_may_have_about_joining_our_platform_as_a_vendor" => "Explore our vendor FAQ section for answers to any queries you may have about joining our platform as a fictory",
	"create_an_account" => "Create an account",
	...
	"if_you`re_not_sure_where_to_find_these_details,_check_the_email_provider`s_documentation_or_support_resources_for_guidance" => "If you`re not sure where to find these details  check the email provider`s documentation or support resources for guidance",
	"Review_ID" => "Review ID",
	"Admin_can_not_reply_to_vendor_product_review" => "Admin can not reply to fictory product review",
	...
	"ReCAPTCHA Failed!" => "ReCAPTCHA Failed!",
	"Vendor_Registration_Successfully_Completed" => "fictory/office Registration Successfully Completed",
	...
	"download_free_vendor_app" => "Download free fictory app",
	...
	"vendor_app" => "fictory app",
	"deliveryman_app" => "Deliveryman app",
	"vendor_panel" => "fictory panel",
	...
	"months)" => "Months)",
	"Month" => "Month",
	"top_vendor" => "Top fictory",
	"top_vendor_list_refers_to_displaying_a_list_based_on_most_ordered_items_of_that_vendor_and_highly_rated" => "Top fictory list refers to displaying a list based on most ordered items of that fictory and highly rated",
	...
	"vendor_product_list" => "Vendor product list",
	"the_vendor_product_list_is_for_displaying_the_products_which_are_mostly_ordered" => "The fictory product list is for displaying the products which are mostly ordered",
	...
	"no_vendor_found" => "No fictory found",
	...
	"Vendor_Registration_Approved" => "fictory/office Registration Approved",
	...
	"set_the_value_in_percentage_for_the_default_commission_that_will_be_received_from_vendors_on_each_order" => "Set the value in percentage for the default commission that will be received from fictories on each order",
