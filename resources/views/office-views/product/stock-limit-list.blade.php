                        ...
                        <div class="row justify-content-between align-items-center gy-2">
                            ...
                            <div class="col-12 mt-1 col-md-6 col-lg-3">
                                <select name="qty_order_sort" class="form-control action-select-onchange-get-view"
                                        data-url-prefix="{{ route('office.products.stock-limit-list') }}/?sortOrderQty=">
                        ...
                        <table id="datatable"
                            ...
                            @foreach($products as $key => $product)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center justify-content-center">
                                            ...
                                            <button class="btn py-0 px-2 fz-18 action-update-product-quantity"
                                                    id="{{ $product['id'] }}"
                                                    data-url="{{ route('office.products.get-variations').'?id='.$product['id'] }}"
                                    ...
                                    <td class="text-center">
                                        <form action="{{route('office.products.status-update') }}" method="post"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    <form action="{{ route('office.products.update-quantity') }}" method="post">
                        @csrf
