...
@section('content')
                                ...
                                <div class="row gy-2 flex-grow-1">
                                    <div class="col-12">
                                        <div class="d-md-flex justify-content-md-between">
                                            ...
                                            <a class="btn btn--primary btn-sm" href="{{route('office.products.update',['id'=>$product['id'],'product-gallery'=>1]) }}">
    ...
    <span id="get-product-gallery-route" data-action="{{route('office.products.product-gallery')}}" data-brand-id="{{request('brand_id')}}" data-category-id="{{request('category_id')}}" data-vendor-id="{{request('vendor_id')}}">
@endsection
