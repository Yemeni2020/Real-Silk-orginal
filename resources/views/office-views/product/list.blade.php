...
@section('title', translate($type=='new-request'?'pending_Services':($type=='approved'?'approved_Services':'service_list')))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
                ...
                {{ translate($type=='new-request'?'pending_for_approval_Services':($type=='approved'?'approved_Services':'service_list')) }}
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ url()->current() }}" method="GET">
                    ...
                    <div class="row gx-2">
                        <div class="col-12">
                            <h4 class="mb-3">{{ translate('filter_Services') }}</h4>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end">
                                <a href="{{ route('office.products.list', ['type'=>request('type')]) }}"
                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('office.products.export-excel', ['type'=>$type,'brand_id'=>request('brand_id'),'category_id'=>request('category_id'),'sub_category_id'=>request('sub_category_id'),'sub_sub_category_id'=>request('sub_sub_category_id'),'searchValue'=>request('searchValue')]) }}">
                                ...
                                @if($type != 'new-request' )
                                <a href="{{ route('office.products.stock-limit-list') }}" class="btn btn-info">
                                    <i class="tio-add-circle"></i>
                                    <span class="text">{{ translate('limited_Stocks') }}</span>
                                </a>
                                <a href="{{ route('office.products.add') }}" class="btn btn--primary">
                                    <i class="tio-add"></i>
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                <th>{{ translate('SL') }}</th>
                                <th class="text-capitalize">{{ translate('service_name') }}</th>
                            ...
                            @foreach($products as $key=>$product)
                                <tr>
                                    ...
                                    <td style="white-space: normal; word-wrap: break-word; max-width: 200px;">
                                        <a href="{{ route('office.products.view', [$product['id']]) }}"
                                    ...
                                    @if($type != 'new-request' )
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('office.products.status-update') }}" method="post" data-from="product-status"
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-2">
                                            @if($type != 'new-request' )
                                                <a class="btn btn-outline-info btn-sm square-btn"
                                                   ...
                                                   href="{{ route('office.products.barcode', [$product['id']]) }}">
                                                    <i class="tio-barcode"></i>
                                                </a>
                                                <a class="btn btn-outline-info btn-sm square-btn" title="{{ translate('view') }}"
                                                   href="{{ route('office.products.view', [$product['id']]) }}">
                                                    <i class="tio-invisible"></i>
                                                </a>
                                            @endif
                                            <a class="btn btn-outline--primary btn-sm square-btn"
                                               title="{{ translate('edit') }}"
                                               href="{{ route('office.products.update',[$product['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                        ...
                                        <form action="{{ route('office.products.delete',[$product['id']]) }}"
