                            ...
                            <div class="d-flex col-auto gap-3">
                                ...
                                <div>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('admin.offices.withdraw-list-export-excel') }}?approved={{request('approved')}}">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($withdrawRequest->seller))
                                            <a href="{{route('admin.offices.view', $withdrawRequest->seller_id)}}" class="title-color hover-c1">{{ $withdrawRequest->seller->f_name . ' ' . $withdrawRequest->seller->l_name }}</a>
                                        @else
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            @if (isset($withdrawRequest->seller))
                                            <a href="{{route('admin.offices.withdraw_view', ['withdrawId'=>$withdrawRequest['id'], 'vendorId'=>$withdrawRequest->seller['id']])}}"
