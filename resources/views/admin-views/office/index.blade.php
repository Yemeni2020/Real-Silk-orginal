...
@section('title', translate('office_List'))
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-merge input-group-custom width-500px">
                                        ...
                                        <input id="datatableSearch_" type="search" name="searchValue" class="form-control"
                                            placeholder="{{translate('search_by_office_name_or_name_or_phone_or_email')}}" aria-label="Search orders" value="{{ request('searchValue') }}">
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <div class="dropdown text-nowrap">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a type="submit" class="dropdown-item d-flex align-items-center gap-2 " href="{{route('admin.offices.export',['searchValue' => request('searchValue')])}}">
                                ...
                                <a href="{{route('admin.offices.add')}}" type="button" class="btn btn--primary text-nowrap">
                                    <i class="tio-add"></i>
