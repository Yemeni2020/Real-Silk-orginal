                ...
                @if ($seller['status']=="pending")
                    <div class="mt-4 pr-2">
                        <div class="flex-start">
                            ...
                            <div>{{ translate('office_request_for_open_a_shop') }}</div>
                        </div>
                        ...
                        <table id="datatable"
                            ...
                            @foreach($transactions as $key=>$transaction)
                                <tr>
                                    ...
                                    <td>{{setCurrencySymbol(amount: usdToDefaultCurrency(amount: $transaction['referral_commission']))}}</td>
