...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                <ul class="nav nav-tabs flex-wrap page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link " href="{{ route('admin.offices.view',$seller->id) }}">{{translate('shop')}}</a>
                    </li>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                <form action="{{ route('admin.offices.update-setting',['id'=>$seller['id']]) }}" method="post">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            ...
                            <label class="switcher" for="commission-status">
                                <input type="checkbox" class="switcher_input toggle-switch-message" value="1" name="commission_status"
                                       ...
                                       data-on-title="{{translate('want_to_Turn_ON_Sales_Commission_For_This_office')}}"
                                       data-off-title="{{translate('want_to_Turn_OFF_Sales_Commission_For_This_office')}}"
                        ...
                        <div class="card-header">
                            ...
                            <label class="switcher" for="gst-status">
                                <input type="checkbox" class="switcher_input toggle-switch-message" value="1" name="gst_status" id="gst-status" {{ $seller['gst'] !=null ? 'checked':'' }}
                                       ...
                                       data-on-image="general-icon.png"
                                       data-off-image="general-icon.png"
                                       data-on-title="{{translate('want_to_Turn_ON_GST_Number_For_This_office')}}"
                                       data-off-title="{{translate('want_to_Turn_OFF_GST_Number_For_This_office')}}"
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color text-capitalize">
                                        {{translate('office_POS_permission')}}
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('if_enabled_this_office_can_access_POS_from_the_website_and_office_app') }}">
                                    ...
                                    <label class="switcher" for="seller-pos">
                                        <input type="checkbox" class="switcher_input toggle-switch-message" value="1" name="seller_pos"
                                               ...
                                               data-on-title="{{translate('want_to_Turn_ON_POS_For_This_office')}}"
                                               data-off-title="{{translate('want_to_Turn_OFF_POS_For_This_office')}}"
                                               data-on-message="<p>{{translate('if_enabled_this_office_can_access_POS_from_the_website_and_office_app')}}</p>"
                                               data-off-message="<p>{{translate('if_disabled_this_office_cannot_access_POS_from_the_website_and_office_app')}}</p>">
                                        <span class="switcher_control"></span>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="d-flex justify-content-between align-items-center gap-10 form-control">
                                    <span class="title-color text-capitalize">
                                        ...
                                        <span class="input-label-secondary cursor-pointer" data-toggle="tooltip" data-placement="right" title="{{translate('if_enabled_this_office_can_access_POS_from_the_website_and_vendor_app') }}">
                                            <img width="16" src="{{dynamicAsset(path: 'public/assets/back-end/img/info-circle.svg')}}" alt="">
                                        </span>
                                    </span>
