                        ...
                        <div class="card-body d-flex flex-column gap-2">
                            <div class="mb-3">
                                ...
                                <div class="flex-start mb-1">
                                    <strong class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'ml-1' : 'mr-1'}}">{{translate('subject')}}: </strong>
                                    <div><strong>{{$contact->subject}}</strong></div>
                                </div>
                                <div class="flex-start">
                                    <strong class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'ml-1' : 'mr-1'}}">{{translate('message')}}: </strong>
