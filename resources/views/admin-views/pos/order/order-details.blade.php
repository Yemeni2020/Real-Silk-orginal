                                                ...
                                                <div class="media align-items-center gap-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <?php /*setCurrencySymbol(amount: usdToDefaultCurrency(amount:  $productDetails['unit_price']+($productDetails->tax_model =='include' ?0: $productDetails['tax'])), currencyCode: getCurrencyCode())*/ ?>
