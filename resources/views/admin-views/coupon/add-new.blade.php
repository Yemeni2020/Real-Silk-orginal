            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                               class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table {{ request()->cookie('direction', 'ltr') === 'rtl' ? 'text-right' : 'text-left' }}">
