            ...
            <div class="col-sm-12 mb-3">
                <div class="card">
                    ...
                    <div class="table-responsive datatable-custom">
                        <table class="table table-hover table-borderless table-thead-bordered table-align-middle card-table {{ request()->cookie('direction', 'ltr') === 'rtl' ? 'text-right' : 'text-left' }}">
