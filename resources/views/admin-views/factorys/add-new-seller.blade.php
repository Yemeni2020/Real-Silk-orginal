...
@section('title', translate('add_new_Factory'))
@section('content')
<div class="content container-fluid main-card {{Session::get('direction')}}">
    <div class="mb-4">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{ translate('add_new_Factory') }}
        </h2>
    </div>
    <form class="user" action="{{route('factory.apply')}}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card">
            <div class="card-body">
