    ...
    <div class="mb-3">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a title="{{translate('view')}}"
                                            ...
                                            href="{{route('admin.vendors.view',$_seller->id)}}">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <form action="route('admin.vendors.referral',['id'=>$seller['id'], 'tab'=>'referral']" method="post">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <form action="{{ route('admin.vendors.referral',['id'=>$_seller['id'], 'tab'=>'referral']) }}"
