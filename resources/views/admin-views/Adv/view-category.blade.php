...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.adver.store-category') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center gap-10">
                                            <a class="btn btn-outline-info btn-sm square-btn "
                                               ...
                                               href="{{ route('admin.adver.update-category',[$category['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            <a class="btn btn-outline-danger btn-sm square-btn delete-category"
                                               title="{{ translate('delete') }}"
                                               data-product-count = "{{count($category?->Adv)}}"
                                               data-text=""
                                               id="{{ $category['id'] }}">
    ...
    <span id="route-admin-category-delete" data-url="{{ route('admin.adver.delete-category') }}"></span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 pb-sm-5">
                    ...
                    <form action="{{ route('admin.adver.delete-category') }}" method="post" class="product-category-update-form-submit">
                        @csrf
