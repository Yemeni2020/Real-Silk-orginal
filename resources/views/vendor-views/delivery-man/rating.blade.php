                ...
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            <img class="avatar avatar-xxl avatar-4by3 {{request()->cookie('direction', 'ltr') === "rtl" ? 'ml-4' : 'mr-4'}}"
                            ...
                            <div class="d-block">
                                ...
                                <p> {{translate('of')}} {{$reviews->count()?? 0}} {{translate('reviews')}}
                                    <span
                                        class="badge badge-soft-dark badge-pill {{request()->cookie('direction', 'ltr') === "rtl" ? 'mr-1' : 'ml-1'}}"></span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md">
                        <ul class="list-unstyled list-unstyled-py-2 mb-0">
                            <li class="d-flex align-items-center font-size-sm">
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'ml-3' : 'mr-3'}}">{{'5'.' '.translate('star')}}</span>
                                ...
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'mr-3' : 'ml-3'}}">{{$five}}</span>
                            </li>
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                ...
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'mr-3' : 'ml-3'}}">{{$four}}</span>
                            </li>
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                ...
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'mr-3' : 'ml-3'}}">{{$three}}</span>
                            </li>
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                ...
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'mr-3' : 'ml-3'}}">{{$two}}</span>
                            </li>
                            <li class="d-flex align-items-center font-size-sm">
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'ml-3' : 'mr-3'}}">{{translate('1')}} {{translate('star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                                ...
                                <span class="{{request()->cookie('direction', 'ltr') === "rtl" ? 'mr-3' : 'ml-3'}}">{{$one}}</span>
                            </li>
                        </ul>
                    </div>
