...
@section('content')
                            ...
                            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table w-100 text-start">
                                ...
                                @foreach($brands as $key => $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('vendor.brand.status-update') }}" method="post" id="brand-status{{$brand['id']}}-form">
                                                @csrf
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="btn btn-outline-info btn-sm square-btn" title="{{ translate('edit') }}"
                                                    href="{{ route('vendor.brand.update', [$brand['id']]) }}">
                                                    <i class="tio-edit"></i>
                                                </a>
    ...
    <span id="route-admin-brand-delete" data-url="{{ route('vendor.brand.delete') }}"></span>
    <span id="route-admin-brand-status-update" data-url="{{ route('vendor.brand.status-update') }}"></span>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content shadow-lg">
                ...
                <div class="modal-body px-4 px-sm-5 pt-0 pb-sm-5">
                    ...
                    <form action="{{ route('vendor.brand.delete') }}" method="post" class="product-brand-update-form-submit">
                        @csrf
