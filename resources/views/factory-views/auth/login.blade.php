...
<head>
    ...
    <title>{{translate('factory_login')}}</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-7 col-lg-5">
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        <form action="{{route('factory.auth.login')}}" method="post" id="vendor-login-form">
                            @csrf
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">{{translate('sign_in')}}</h1>
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">{{translate('welcome_back_to_factory_login')}}</h1>
                                    </div>
                                </div>
                            </div>
                            ...
                            @else
                                <div class="row py-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control __h-40 border-0" name="factoryRecaptchaKey" value=""
                                    ...
                                    <div class="col-6 input-icons mb-2 w-100 rounded bg-white">
                                        <a class="d-flex align-items-center align-items-center get-login-recaptcha-verify"
                                           data-link="{{ URL('/factory/auth/recaptcha') }}">
                                            <img src="{{ URL('/factory/auth/recaptcha/1?captcha_session_id=factoryRecaptchaSessionKey') }}"
